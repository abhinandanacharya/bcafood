      ...
      <form action="main.php" method="post">
        ...
        <div class="list">
          <div class="form-control" >
            <label>Potato</label> 
            <input type="radio" name="vegitable" value="11" class="pull-right" >
          </div>

          <div class="form-control">
           <label>Pea</label>
           <input type="radio" name="vegitable" value="15" class="pull-right">
         </div>

         <div class="form-control">
          <label>Tomato</label>
          <input type="radio" name="vegitable" value="12" class="pull-right">
        </div>

        <div class="form-control">
         <label>Cauliflower</label>
         <input type="radio" name="vegitable" value="20" class="pull-right">
       </div>

       <div class="form-control">
         <label>Cabbage</label>
         <input type="radio" name="vegitable" value="17" class="pull-right">
       </div>

       <div class="form-control">
         <label>Capsicum</label>
         <input type="radio" name="vegitable" value="16" class="pull-right">
       </div>

       <div class="form-control">
         <label>Carrot</label>
         <input type="radio" name="vegitable" value="19" class="pull-right">
       </div>

       <div class="form-control">
         <label>Chilli</label>
         <input type="radio" name="vegitable" value="18" class="pull-right">
       </div>
